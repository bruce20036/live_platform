...
ZMQ_MT_SUB_TCP              = "tcp://127.0.0.1:5563"  # Where Sub server connects
...
ZMQ_XSUB_ADDRESS            = "tcp://127.0.0.1:6001"  # Where workers connect
ZMQ_XPUB_ADDRESS            = "tcp://127.0.0.1:6000"  # Where media_boxes connect
